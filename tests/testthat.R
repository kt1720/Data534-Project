...
source("../R/process_NA.R")
source("../R/process_outlier.R")
source("../R/average_median_bar_plot.R")
...
#   generated_img <- magick::image_read("../R/overall_wage_trend.png")
#   # # comparing image
...
#   # Check if a plot has been created
#   generated_img <- magick::image_read("../R/get_wage/Data534-Project/R/special_wage_trend.png")
#   # Check some properties of the image
#   expect_true(magick::image_info(generated_img)$width == 2400)
#   expect_true(magick::image_info(generated_img)$height== 1800)
#   expect_true(length(dev.list()) > 0)
...
#   generated_img <- magick::image_read("../R/special_wage_trend.png")
#   # Check some properties of the image
#   # expect_true(magick::image_info(generated_img)$width == 2400)
#   # expect_true(magick::image_info(generated_img)$height== 1800)
#   expect_true(length(dev.list()) > 0)
