...
# test suite 4: Check if missing values and outliers detected successfully
testthat::test_that("identify NAs successfully",{
  result <- process_NA(c(1,2,3,4,5))
  testthat::expect_equal(result, "No missing values detected")
})
...
testthat::test_that("identify outliers successfully", {
  ...
  testthat::expect_equal(score_result, expected_score)
})
